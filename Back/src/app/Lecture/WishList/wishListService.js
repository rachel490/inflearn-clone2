...
exports.createWishList = async function (userId) {
	...
	try {
		...
		if (resultRows.affectedRows === 0) return errResponse(baseResponse.CREATE_WISH_LIST_FAIL);
...
exports.insertWishListItem = async function (wishListId, lectureId) {
	...
	try {
		...
		if (resultRows.affectedRows === 0) return errResponse(baseResponse.INSERT_WISH_LIST_ITEM_FAIL);
...
exports.deleteWishListItem = async function (wishListId, lectureId) {
	...
	try {
		...
		if (resultRows.affectedRows === 0) return errResponse(baseResponse.DELETE_WISH_LIST_ITEM_FAIL);
